...
public:
	...
	void Identity() {
		columns[0][0] = 1; columns[0][1] = 0; columns[0][2] = 0; columns[0][3] = 0;
		columns[1][0] = 0; columns[1][1] = 1; columns[1][2] = 0; columns[1][3] = 0;
		columns[2][0] = 0; columns[2][1] = 0; columns[2][2] = 1; columns[2][3] = 0;
		columns[3][0] = 0; columns[3][1] = 0; columns[3][2] = 0; columns[3][3] = 1;
	}
	XMatrix44<T> GetIdentity() {
		XMatrix44<T> Id;
		Identity.Identity();
		return Id;
	}
