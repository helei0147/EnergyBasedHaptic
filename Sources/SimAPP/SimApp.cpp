...
void Renderer::doUI() {
	...
	ImGui::PlotLines("Force x", forcex, IM_ARRAYSIZE(forcex), values_offset, nullptr, -1.0f, 1.0f, ImVec2(0, 80.0f));
	ImGui::PlotLines("Force y", forcey, IM_ARRAYSIZE(forcey), values_offset, nullptr, -1.0f, 1.0f, ImVec2(0, 80.0f));
	ImGui::PlotLines("Force z", forcez, IM_ARRAYSIZE(forcez), values_offset, nullptr, -1.0f, 1.0f, ImVec2(0, 80.0f));
...
void loadSofts(std::string dataFolder = "../../data/") {
	...
	g_simManager->m_softHapticSolver.k_c = 8;
	g_simManager->m_softHapticSolver.k_vct = 80;
	g_simManager->m_softHapticSolver.tv_volumnStiffness = 372.0f;
	g_simManager->m_softHapticSolver.tv_collisionStiffness = 160.0f;
